...
public class Tab9Fragment extends Fragment {
    ...
    private PhotoAdapter photoTab9Adapter;

    public Tab9Fragment() {
        // Required empty public constructor
    }

    public static Tab9Fragment newInstance(String param1, String param2) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewPager = view.findViewById(R.id.viewPagerTab9);

        photoTab9Adapter = new PhotoAdapter(getContext(),getListPhoto());
        viewPager.setAdapter(photoTab9Adapter);
    }
