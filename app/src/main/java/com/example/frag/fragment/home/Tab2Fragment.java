...
public class Tab2Fragment extends Fragment {
    ...
    private PhotoAdapter photoTab2Adapter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewPager = view.findViewById(R.id.viewPagerTab2);

        photoTab2Adapter = new PhotoAdapter(getContext(),getListPhoto());
        viewPager.setAdapter(photoTab2Adapter);
    }
