...
public class Tab8Fragment extends Fragment {
    ...
    private PhotoAdapter photoTab8Adapter;

    public Tab8Fragment() {
        // Required empty public constructor
    }

    public static Tab8Fragment newInstance(String param1, String param2) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewPager = view.findViewById(R.id.viewPagerTab8);

        photoTab8Adapter = new PhotoAdapter(getContext(),getListPhoto());
        viewPager.setAdapter(photoTab8Adapter);
    }
