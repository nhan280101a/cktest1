...
public class Tab5Fragment extends Fragment {
    ...
    private PhotoAdapter photoTab5Adapter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewPager = view.findViewById(R.id.viewPagerTab5);

        photoTab5Adapter = new PhotoAdapter(getContext(),getListPhoto());
        viewPager.setAdapter(photoTab5Adapter);
    }
