...
public class Tab11Fragment extends Fragment {
    ...
    private PhotoAdapter photoTab11Adapter;

    public Tab11Fragment() {
        // Required empty public constructor
    }

    public static Tab11Fragment newInstance(String param1, String param2) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewPager = view.findViewById(R.id.viewPagerTab11);

        photoTab11Adapter = new PhotoAdapter(getContext(),getListPhoto());
        viewPager.setAdapter(photoTab11Adapter);
    }
