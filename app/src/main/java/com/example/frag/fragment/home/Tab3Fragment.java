...
public class Tab3Fragment extends Fragment {
    ...
    private PhotoAdapter photoTab3Adapter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewPager = view.findViewById(R.id.viewPagerTab3);

        photoTab3Adapter = new PhotoAdapter(getContext(),getListPhoto());
        viewPager.setAdapter(photoTab3Adapter);
    }
