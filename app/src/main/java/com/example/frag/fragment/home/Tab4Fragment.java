...
public class Tab4Fragment extends Fragment {
    ...
    private PhotoAdapter photoTab4Adapter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewPager = view.findViewById(R.id.viewPagerTab4);

        photoTab4Adapter = new PhotoAdapter(getContext(),getListPhoto());
        viewPager.setAdapter(photoTab4Adapter);
    }
